// Dateiname: lotto.c
// Das programm brechnet den binomialkoeffizienzen n über k, liest tippzahlen ein und berechnet mit hilfe der rand() funktion gewinnzahlen, solange bis mindestens 3 richtige mit ihrem tipp übereinstimmen
// dann werden die zahlen geordnet und ausgegeben.
// Eingabeparameter mit zulässigem Wertebereich: n und k 0<k<n<90 die anzahl der tippzahlen ist k, n ist die obere schranke des zahlenpools
// Ausgaben mit zulässigem Wertebereich: ausgabe ist der binomialkoeffizient, die anzahl der richtigen, ihr tipp, der tipp des computers bei min. 3 richtigen, die gewinnzahlen
// Autor: jan Taschbach
// Version: 1.1
